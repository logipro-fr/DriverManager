 ...
 */
class DriveManager_Infrastructure_Shared_Symfony_KernelTestDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'DriveManager\\Infrastructure\\Api\\V1\\DropFileController' => 'getDropFileControllerService',
            ...
            'drivemanager.DropFileInterface' => 'getDrivemanager_DropFileInterfaceService',
            'drivemanager.repository' => 'getDrivemanager_RepositoryService',
        ...
        $this->aliases = [
            'DriveManager\\Infrastructure\\Shared\\Symfony\\Kernel' => 'kernel',
        ];
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['DriveManager\\Infrastructure\\Shared\\Symfony\\Kernel', 'DriveManager\\Infrastructure\\Api\\V1\\DropFileController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/DriveManager_Infrastructure_Shared_Symfony_KernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'DriveManager_Infrastructure_Shared_Symfony_KernelTestDebugContainer',
