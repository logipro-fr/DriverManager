 ...
 */
class DriveManager_Infrastructure_Shared_Symfony_KernelDevDebugContainer extends Container
{
    protected $targetDir;
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['DriveManager\\Infrastructure\\Shared\\Symfony\\Kernel', 'DriveManager\\Infrastructure\\Api\\V1\\DropFileController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/DriveManager_Infrastructure_Shared_Symfony_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'DriveManager_Infrastructure_Shared_Symfony_KernelDevDebugContainer',
